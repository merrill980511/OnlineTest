...
<body>
<form name="form" action="/admin/testPaper?cmd=addTestPaperResult" method="post" >
    <a href="/admin/testPaper?cmd=auto">自动生成试卷</a>
    <table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <th colspan="2">试卷编号：</th>
            <td><input type="text" name="testPaperId" width="300" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <th colspan="2">开始时间：(yyyy/MM/dd HH:mm)</th>
            <td ><input type="datetime" name="startTime" width="100" /></td>
        </tr>
        <tr>
            <th colspan="2">结束时间：(yyyy/MM/dd HH:mm)</th>
            <td><input type="datetime" name="endTime" width="100" /></td>
        </tr>
        <tr>
            <th colspan="2">总时长（分钟）：</th>
            <td ><input type="number" name="time" min="1" width="100"/></td><br/>
        </tr>
        <c:forEach items="${testPaper2.questions}" var="question">
            <tr>
